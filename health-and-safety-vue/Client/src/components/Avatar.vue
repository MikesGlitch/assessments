      ...
      <g id="Avataaar/Circle" transform="translate(-825.000000, -1100.000000)">
        <g transform="translate(825.000000, 1100.000000)">
          <g id="Circle" stroke-width="1" fill-rule="evenodd" transform="translate(12.000000, 40.000000)">
            <mask id="react-mask-4" fill="white"><use xlink:href="#react-path-1"></use></mask>
            <use id="Circle-Background" fill="white" xlink:href="#react-path-1"></use>
            <g id="Color/Palette/Blue-01" mask="url(#react-mask-4)" fill="#60A5FA">
          ...
          <g id="Avataaar" stroke-width="1" fill-rule="evenodd" mask="url(#react-mask-5)">
            ...
            <g id="Clothing/Hoodie" transform="translate(0.000000, 170.000000)">
              ...
              <mask id="react-mask-588" fill="white"><use xlink:href="#react-path-587"></use></mask>
              <use id="Hoodie" fill="#B7C1DB" fill-rule="evenodd" xlink:href="#react-path-587"></use>
              <g id="Color/Palette/Gray-01" mask="url(#react-mask-588)" fill-rule="evenodd" fill="#3C4F5C">
            ...
            <g id="Face" transform="translate(76.000000, 82.000000)" fill="#000000">
              <g id="Mouth/Smile" transform="translate(2.000000, 52.000000)">
                ...
                <mask id="react-mask-716" fill="white"><use xlink:href="#react-path-715"></use></mask>
                <use
                  id="Mouth"
                ...
                <rect
                  ...
                  rx="5"
                ></rect>
                <g id="Tongue" stroke-width="1" fill-rule="evenodd" mask="url(#react-mask-716)" fill="#FF4F6D">
            ...
            <g id="Top" stroke-width="1" fill-rule="evenodd">
              <defs>
                <rect id="react-path-381" x="0" y="0" width="264" height="280"></rect>
                <path
                  id="react-path-380"
              ...
              <mask id="react-mask-379" fill="white"><use xlink:href="#react-path-381"></use></mask>
              <g id="Mask"></g>
              <g id="Top/Short-Hair/Short-Waved" mask="url(#react-mask-379)">
                <g transform="translate(-1.000000, 0.000000)">
                  <g id="Facial-Hair/Beard-Light" transform="translate(49.000000, 72.000000)">
                    ...
                    <mask id="react-mask-483" fill="white"><use xlink:href="#react-path-484"></use></mask>
                    <use id="Lite-Beard" fill="#331B0C" fill-rule="evenodd" xlink:href="#react-path-484"></use>
                    <g id="Color/Hair/Brown" mask="url(#react-mask-483)" fill="#4A312C">
                      <g id="Color" transform="translate(-32.000000, 0.000000)">
                        <rect x="0" y="0" width="264" height="244"></rect>
                      </g>
                    </g>
                  </g>
                  <mask id="react-mask-378" fill="white"><use xlink:href="#react-path-380"></use></mask>
                  <use
                    id="Short-Hair"
                    stroke="none"
                    fill="#28354B"
                  ...
                  ></use>
                  <g id="Skin/👶🏽-03-Brown" mask="url(#react-mask-378)" fill="#4A312C">
                    <g id="Color" transform="translate(0.000000, 0.000000) ">
                      <rect x="0" y="0" width="264" height="280"></rect>
                    </g>
                  </g>
